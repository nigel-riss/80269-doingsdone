...
$tasks = [
    ...
    ['Сделать задание первого раздела', '21.12.2019', 'Учеба', false],
    ['Встреча с другом', '22.12.2019', 'Входящие', true],
    ['Купить корм для кота', 'Нет', 'Домашние дела', false],
    ['Заказать пиццу', 'Нет', 'Домашние дела', false]
];
?>
<!DOCTYPE html>
<html lang="ru">
